...
public class ElasticSearchTutPart2Test extends AbstractSearchJUnit4SpringContextTests
{
	 ...
	 @Test
	    public void searchInMultipleIndexes()
	    {
	        ...
	        searchCriteria.indices(ElasticSearchIndexConfig.COM_WEBSITE.getIndexAliasName(), ElasticSearchIndexConfig.NL_WEBSITE.getIndexAliasName());
	    //    searchCriteria.documentTypes(config.getDocumentType());
	        searchCriteria.documentTypes(ElasticSearchIndexConfig.COM_WEBSITE.getDocumentType());
	     //   searchCriteria.addFiledValueFilter("description", "description10");
	        searchCriteria.addFiledValueFilter("resolution", "1024 x 758");
	        
	       // searchCriteria.addFiledValueFilter("_id", "10");
	        ProductProperty productProperty = new ProductProperty();
	        productProperty.setColor("Yellow");
	       // searchCriteria.addProductProperty(productProperty);
	        //searchCriteria.addFiledValueFilter("price", new BigDecimal("49"));
	       // searchCriteria.size(0);
	        ProductSearchResult searchProducts = productQueryService.searchProducts(searchCriteria);
	        //new ProductQueryServiceImpl().bulkIndex();
